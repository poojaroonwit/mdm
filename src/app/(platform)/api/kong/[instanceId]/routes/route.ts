...
async function getHandler(
  ...
  const { session } = authResult
    ...
    const response = await fetch(`${config.adminUrl}/routes`, {
      method: 'GET',
      headers,
    })
...
export const GET = withErrorHandling(getHandler, 'GET /api/kong/[instanceId]/routes')
...
export const POST = withErrorHandling(postHandler, 'POST /api/kong/[instanceId]/routes')
