...
export const GET = withErrorHandling(getHandler, 'GET /api/kong/[instanceId]/services/[id]')
...
export const PUT = withErrorHandling(putHandler, 'PUT /api/kong/[instanceId]/services/[id]')
...
export const DELETE = withErrorHandling(deleteHandler, 'DELETE /api/kong/[instanceId]/services/[id]')
