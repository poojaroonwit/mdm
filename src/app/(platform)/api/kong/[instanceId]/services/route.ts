...
async function getHandler(
  ...
  const { session } = authResult
    ...
    const response = await fetch(`${config.adminUrl}/services`, {
      method: 'GET',
      headers,
    })
...
export const GET = withErrorHandling(getHandler, 'GET /api/kong/[instanceId]/services')
...
export const POST = withErrorHandling(postHandler, 'POST /api/kong/[instanceId]/services')
