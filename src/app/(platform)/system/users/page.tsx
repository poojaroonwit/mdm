      ...
      <Tabs defaultValue="users" className="w-full">
        <div className="border-b border-border mb-4">
          <TabsList className="w-full h-auto p-0 bg-transparent justify-start gap-0">
            <TabsTrigger
              value="users"
              className="relative px-6 py-3 rounded-none border-b-2 border-transparent data-[state=active]:border-primary data-[state=active]:bg-transparent bg-transparent hover:bg-muted/50 transition-all"
            >
