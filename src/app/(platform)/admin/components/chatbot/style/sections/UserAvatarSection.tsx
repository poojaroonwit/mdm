...
import { UserCircle, Upload, X, Bot } from 'lucide-react'
    ...
    <div className="py-2 w-full">
      <div className="px-4 pb-4">
        <p className="text-sm text-muted-foreground">
          Configure how the user's avatar appears when they send messages.
        </p>
      </div>

      <AccordionSectionWrapper defaultValue="user-avatar">
        <AccordionSectionGroup id="user-avatar" title="User Avatar" icon={UserCircle} defaultOpen>
          <FormSection>
            <FormRow label="Show Avatar" description="Display avatar for user messages">
              <Switch
            ...
            {formData.showUserAvatar !== false && (
              <>
                ...
                {formData.userAvatarType === 'icon' ? (
                  ...
                  <FormRow label="Avatar Image" description="Custom user image">
