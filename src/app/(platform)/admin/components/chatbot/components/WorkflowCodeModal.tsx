...
import { CheckCircle2, XCircle, AlertTriangle, Code2, Save, Trash2, RefreshCw, Loader2 } from 'lucide-react'
...
import { detectVariables, validateWorkflowCode } from './workflowCodeValidation'
