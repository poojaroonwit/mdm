...
export const defaultBrandingConfig: BrandingConfig = {
    ...
    applicationLogoIconColor: 'hsl(var(--brand-top-menu-text, 0 0% 100%))',
    applicationLogoBackgroundColor: 'hsl(var(--brand-top-menu-bg, 222 47% 11%))',
    ...
    topMenuBackgroundColor: 'hsl(var(--brand-top-menu-bg, 222 47% 11%))',
    ...
    topMenuTextColor: 'hsl(var(--brand-top-menu-text, 0 0% 100%))',
